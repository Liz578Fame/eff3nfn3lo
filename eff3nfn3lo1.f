...
c
      ...
      if (ityp.lt.1.or.ityp.gt.115) go to 9002
c
      im=ime
c
...
c
     ...
     2 10900,11000,11100,11200,11300,11400,11500),ityp
c
c
c
c
...
cc       write(587,*) gint0(i), gints(i), gintss(i), 
cc    1              gint1(i), gint1s(i), gint2(i), gint3(i) 

cc       write(787,*) xkint0(i), xkints(i), xkintss(i),xkintsss(i)
      
cc       write(787,*) xkint1(i), xkint1s(i), xkint2(i), xkint3(i)
cc       write(787,*) xkint1ss(i), xkint2s(i), xkint3s(i)
